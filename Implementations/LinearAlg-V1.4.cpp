// greedy pattern selection with rule permutations and variable permutations
...
vi variableInstancesOrig, variableInstances; // the number of instances of each variable
